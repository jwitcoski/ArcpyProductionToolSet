...
database = r"H:\ArcGIS\20400900000\DB20400900000.gdb"
...
class Zoom(object):
    ...
    def zoomtolayernumber(self, CurrentNumber, CurrentLayer, EditColumn, CommentColumn):
        self.CurrentLayer = CurrentLayer
        self.CurrentNumber = CurrentNumber
        arcpy.SelectLayerByAttribute_management(CurrentLayer, "CLEAR_SELECTION")
        cur = arcpy.da.SearchCursor(CurrentLayer, ['OID@', 'SHAPE@', EditColumn, CommentColumn])
        myOIDs = [x[0] for x in arcpy.da.SearchCursor(CurrentLayer, 'OID@')]
        TotalNum = len(myOIDs)
    ...
    # This will zoom to the first empty feature
    def zoomtolayerattribute(self, CurrentLayer, EditColumn, CommentColumn):
        self.CurrentLayer = CurrentLayer
        arcpy.SelectLayerByAttribute_management(CurrentLayer, "CLEAR_SELECTION")
        cur = arcpy.da.SearchCursor(CurrentLayer, ['OID@', 'SHAPE@', EditColumn, CommentColumn])
        count = int(arcpy.GetCount_management(CurrentLayer).getOutput(0))
...
class BackOne(object):
    ...
    def onClick(self):
        WorkingLayer.object.zoomtolayernumber(WorkingLayer.object.CurrentNumber -1, WorkingLayer.fc, UserType.XYColumn, UserType.CommentColumn)
...
class BackToBeginning(object):
    ...
    def __init__(self):
        ...
        self.checked = False
    def onClick(self):
        WorkingLayer.object.zoomtolayernumber(0, WorkingLayer.fc, UserType.XYColumn, UserType.CommentColumn)
        print WorkingLayer.object.CurrentNumber, WorkingLayer.object.CurrentLayer, WorkingLayer.object.TotalNumber, WorkingLayer.object.XYValue, WorkingLayer.object.CommentValue
...
#Display the Current Feature Number
class CurrentFeatureNumber(object):
    ...
    def onFocus(self, focused):
        pass
    def onEnter(self):
        WorkingLayer.object.zoomtolayernumber(int(CurrentFeatureNumber.num), WorkingLayer.fc, UserType.XYColumn, UserType.CommentColumn)
        print WorkingLayer.object.CurrentNumber, WorkingLayer.object.CurrentLayer, WorkingLayer.object.TotalNumber, WorkingLayer.object.XYValue, WorkingLayer.object.CommentValue
...
class ForwardEmpty(object):
    ...
    def __init__(self):
        ...
        self.checked = False
    def onClick(self):
        WorkingLayer.object.zoomtolayerattribute(WorkingLayer.fc, UserType.XYColumn, UserType.CommentColumn)
        print WorkingLayer.object.CurrentNumber, WorkingLayer.object.CurrentLayer, WorkingLayer.object.TotalNumber, WorkingLayer.object.XYValue, WorkingLayer.object.CommentValue
...
class ForwardOne(object):
    ...
    def __init__(self):
        ...
        self.checked = False
    def onClick(self):
        WorkingLayer.object.zoomtolayernumber(WorkingLayer.object.CurrentNumber + 1, WorkingLayer.fc, UserType.XYColumn,
                                              UserType.CommentColumn)
        print WorkingLayer.object.CurrentNumber, WorkingLayer.object.CurrentLayer, WorkingLayer.object.TotalNumber, WorkingLayer.object.XYValue, WorkingLayer.object.CommentValue
...
class ForwardToEnd(object):
    ...
    def __init__(self):
        ...
        self.checked = False
    def onClick(self):
        WorkingLayer.object.zoomtolayernumber(WorkingLayer.object.TotalNumber -1 , WorkingLayer.fc, UserType.XYColumn, UserType.CommentColumn)
        print WorkingLayer.object.CurrentNumber, WorkingLayer.object.CurrentLayer, WorkingLayer.object.TotalNumber, WorkingLayer.object.XYValue, WorkingLayer.object.CommentValue
...
class WorkingLayer(object):
    ...
    def onSelChange(self, selection):
        self.fc = fc = arcpy.mapping.ListLayers(self.mxd, selection)[0]
        self.object = Zoom()
        print(fc)
